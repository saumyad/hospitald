...
def calculate_wait(no_of_or, beds, h_eff,ans,a_vol):
	wait_time = (ans[0] + ans[1]*no_of_or + ans[2]*beds + ans[3]*h_eff +ans[4]*a_vol+ ans[5]*no_of_or*h_eff + ans[6]*beds*h_eff + ans[7] *no_of_or*beds + ans[8] * no_of_or * a_vol  + ans[9] * beds * a_vol + ans[10] * a_vol * h_eff + ans[11] * no_of_or * no_of_or + ans[12] * beds * beds + ans[13] * h_eff * h_eff + ans[14] * a_vol * a_vol )
	final =  wait_time
	print final
